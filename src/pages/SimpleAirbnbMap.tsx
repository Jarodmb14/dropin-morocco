...
export const SimpleAirbnbMap: React.FC = () => {
  ...
  const handleGPSLocation = async () => {
    try {
      ...
      setCurrentLocation(location);
      alert(`Location detected! Found ${gyms.length} gyms nearby.`);
    } catch (error) {
  ...
  const mapCenter = currentLocation ? [currentLocation.latitude, currentLocation.longitude] : [33.5731, -7.5898];
  const mapZoom = currentLocation ? 15 : 13;
      ...
      <div className="flex h-screen">
        ...
        <div className="w-96 bg-white border-r border-gray-200 p-6 overflow-y-auto">
          ...
          <div className="space-y-4">
            <h3 className="font-semibold text-lg">Nearby Gyms</h3>
